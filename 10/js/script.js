...
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./slider */ "./source/js/modules/slider.js");
/* harmony import */ var _accent_typography__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./accent-typography */ "./source/js/modules/accent-typography.js");
/* harmony import */ var _general_consts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../general/consts */ "./source/js/general/consts.js");
...
class Page {
  constructor() {
    ...
    this.swiper = new _slider__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this.svgAnimations = {};
    this.setTheme();
    ...
    [].forEach.call(this.screenElements, (screen) => {
      ...
      [].forEach.call(accentTypographyElements, (el, index) => {
        this.accentTypographyItems.push({
          _element: new _accent_typography__WEBPACK_IMPORTED_MODULE_2__["default"](
              el,
              500,
          ...
          _screenId: _general_consts__WEBPACK_IMPORTED_MODULE_3__["Screen"][screen.id.toUpperCase()],
        });
      });
    });
  ...
  setTheme(theme = _general_consts__WEBPACK_IMPORTED_MODULE_3__["ThemeColor"].PURPLE) {
  ...
  reinitTheme(event) {
    let themeName;
    this.clearTheme();
    if (event.detail.screenId === _general_consts__WEBPACK_IMPORTED_MODULE_3__["Screen"].STORY) {
  ...
  initPrizeAnimations() {
    ...
    this.svgAnimations[_general_consts__WEBPACK_IMPORTED_MODULE_3__["Screen"].PRIZES] = svgPrizeAnimations;
  }
  ...
  initResultsAnimations() {
    ...
    svgResultAnimationsSettings.forEach((el) => {
      ...
      if (screenElement) {
        ...
        this.svgAnimations[_general_consts__WEBPACK_IMPORTED_MODULE_3__["Screen"][el.id.toUpperCase()]] = [];
        [].forEach.call(svgResultsElements, (svgEl, index) => {
          this.setLetterAnimation(svgEl);
          this.svgAnimations[_general_consts__WEBPACK_IMPORTED_MODULE_3__["Screen"][el.id.toUpperCase()]].push(
              {
