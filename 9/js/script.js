  ...
  showTransitionedBackground() {
    return new Promise((resolve, _reject) => {
      const isShowBackground = [_general_consts__WEBPACK_IMPORTED_MODULE_1__["Screen"].PRIZES, _general_consts__WEBPACK_IMPORTED_MODULE_1__["Screen"].RULES, _general_consts__WEBPACK_IMPORTED_MODULE_1__["Screen"].GAME].indexOf(this.activeScreen) !== -1
                              && [_general_consts__WEBPACK_IMPORTED_MODULE_1__["Screen"].INTRO, _general_consts__WEBPACK_IMPORTED_MODULE_1__["Screen"].STORY].indexOf(this.prevScreen) !== -1;
...
class Page {
  ...
  destroyAnimationsForPrevScreen(event) {
    ...
    if (event.detail.screenId !== _general_consts__WEBPACK_IMPORTED_MODULE_3__["Screen"].PRIZES) {
