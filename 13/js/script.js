...
/* harmony import */ var _accent_typography__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./accent-typography */ "./source/js/modules/accent-typography.js");
/* harmony import */ var _general_consts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../general/consts */ "./source/js/general/consts.js");
...
class Page {
  constructor() {
    ...
    this.swiper = new _slider__WEBPACK_IMPORTED_MODULE_4__["default"]();
    ...
    [].forEach.call(this.screenElements, (screen) => {
      ...
      [].forEach.call(accentTypographyElements, (el, index) => {
        this.accentTypographyItems.push({
          _element: new _accent_typography__WEBPACK_IMPORTED_MODULE_5__["default"](
              el,
              500,
          ...
          _screenId: _general_consts__WEBPACK_IMPORTED_MODULE_6__["Screen"][screen.id.toUpperCase()],
        });
      });
    });
  ...
  setTheme(theme = _general_consts__WEBPACK_IMPORTED_MODULE_6__["ThemeColor"].PURPLE) {
  ...
  reinitTheme(event) {
    let themeName;
    this.clearTheme();
    if (event.detail.screenId === _general_consts__WEBPACK_IMPORTED_MODULE_6__["Screen"].STORY) {
  ...
  updateTimerStatus(screenId) {
    if (screenId === _general_consts__WEBPACK_IMPORTED_MODULE_6__["Screen"].GAME) {
      setTimeout(() => {
  ...
  initJsAnimations() {
    this.jsAnimations[_general_consts__WEBPACK_IMPORTED_MODULE_6__["Screen"].PRIZES] = [
      {
    ...
    this.jsAnimations[_general_consts__WEBPACK_IMPORTED_MODULE_6__["Screen"].RESULT] = [
      {
  ...
  initPrizeAnimations() {
    ...
    this.svgAnimations[_general_consts__WEBPACK_IMPORTED_MODULE_6__["Screen"].PRIZES] = svgPrizeAnimations;
  }
  ...
  initResultsAnimations() {
    ...
    svgResultAnimationsSettings.forEach((el) => {
      ...
      if (screenElement) {
        ...
        this.svgAnimations[_general_consts__WEBPACK_IMPORTED_MODULE_6__["Screen"][el.id.toUpperCase()]] = [];
        [].forEach.call(svgResultsElements, (svgEl, index) => {
          this.setLetterAnimation(svgEl);
          this.svgAnimations[_general_consts__WEBPACK_IMPORTED_MODULE_6__["Screen"][el.id.toUpperCase()]].push(
              {
...
class ResultSealAnimation extends _result_animation__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  snowAnimationFunc(element, progress) {
    element.transforms.translateY = 5 * Math.sin(Object(_general_easing__WEBPACK_IMPORTED_MODULE_1__["easeInOutQuad"])(progress) * 3);
